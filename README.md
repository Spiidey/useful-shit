...
This guide is pretty PWK/OSCP centric, but can be used in a variety of penetration testing / red-team engagements. **DO NOT** have any expectation of not getting caught - the below methods are ***VERY LOUD***.
